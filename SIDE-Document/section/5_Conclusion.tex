...
\begin{itemize}
\item \textbf{Automazione CI/CD}: creazione di ambienti simulati containerizzati (Docker) con configurazioni di rete variabili per testare diversi scenari SCADA in pipeline automatizzate;
...
\item \textbf{Machine Learning avanzato}: integrazione di modelli sofisticati e dataset estesi sui protocolli industriali per migliorare la rilevazione delle anomalie e la previsione di attacchi complessi.
\end{itemize}