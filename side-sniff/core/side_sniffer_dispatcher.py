from services.side_sniff_handlers_service import (
    modbus_packet_handler,
    s7_packet_handler,
    opcua_packet_handler,
)
...
PROTOCOL_HANDLERS = {
    ...
    Protocol.SNAP_7.value: s7_packet_handler,
    Protocol.OPC_UA.value: opcua_packet_handler,
